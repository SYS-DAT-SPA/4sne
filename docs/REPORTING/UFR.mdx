...
UFR è l'acronimo di **Unified  Framework Reporting**.   

E’ il modulo di Next che consente di creare **reportistica** ed **analisi di dati** attingendo informazioni da qualsiasi applicativo Sys-Dat, ed in generale, 
da qualsiasi fonte dati anche esterna.  

A differenza di un qualsiasi altro strumento di Business Intelligence i dati vengono letti in **tempo reale.**  

---   

In linea generale, nel modulo è possibile:  
- **Definire i sistemi informativi su cui si vuole operare.** 
- **Definire query SQL, più o meno complesse, per creare elementi di analisi definiti [Report](Report/Gestione_Report):** 
- **Accorpare più report all’interno di una [Dashboard](Dashboard/Gestione_Dashboard) o raggrupparli in un menù utente.**  

 ---  
 
  **In questa guida troverai informazioni su come:**  
  
  [Creare e gestire un report.](Report/Gestione_Report) 
  
  [Creare e gestire una dashboard.](Dashboard/Gestione_Dashboard) 
  
  [Agganciare un report o una dashboard in un menù utente](Menu/Azioni).  
